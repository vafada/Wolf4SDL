...
// The ffData... variables contain the 16-bit values of the according corners of
// the current level. The corners are overwritten with adjacent tiles after
// initialization in SetupGameLevel to avoid interpretation as e.g. doors.
...
// The feature flags are stored as a wall in the upper right corner of each
// level
static inline word GetFeatureFlags(void) { return ffDataTopRight; }
