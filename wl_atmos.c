...
byte moon[100] = {
    0,  0,  27, 18, 15, 16, 19, 29, 0,  0,  0,  22, 16, 15, 15, 16, 16,
    18, 24, 0,  27, 17, 15, 17, 16, 16, 17, 17, 18, 29, 18, 15, 15, 15,
    16, 16, 17, 17, 18, 20, 16, 15, 15, 16, 16, 17, 17, 18, 19, 21, 16,
    15, 17, 20, 18, 17, 18, 18, 20, 22, 19, 16, 18, 19, 17, 17, 18, 19,
    22, 24, 28, 19, 17, 17, 17, 18, 19, 21, 25, 31, 0,  23, 18, 19, 18,
    20, 22, 24, 28, 0,  0,  0,  28, 21, 20, 22, 28, 30, 0,  0,
};
  ...
  if (xx > (scaleFactor * -10) && xx < viewwidth) {
    ...
    while (i < stopx) {
      for (j = starty; j < stopy; j++)
        vbuf[ylookup[yy + j] + xx + i] =
            moon[((j / scaleFactor) * 10) + (i / scaleFactor)];
